...
export default function Navbar() {
    ...
    return (
        <div className='w-full grid grid-cols-1 md:grid-cols-8'>
            ...
            <nav className="bg-white shadow dark:bg-gray-800 col-span-6">
            ...
            <div className='col-span-1 text-center flex justify-center items-center text-gray-800 font-mono font-semibold'>
                <Link href="www.linkedin.com/in/guillermo-cuamea-telles-284308138" target="_blank" className='ml-2'><BsLinkedin /></Link>
